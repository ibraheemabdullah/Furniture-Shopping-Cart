...
<input type="submit" ng-click="ctr.getSelectedUser()" class="w3-btn  w3-deep-purple w3-border w3-border-blue w3-round-xlarge" value="My Profile"/>
</div>
</div>
        ...
        <div class="iconbox">
          ...
          <div class="featureinfo">
            ...
            <a class="w3-btn  w3-indigo w3-border w3-border-dark-blue w3-round-xlarge" href="#/blog" role="button">Create Blogs</a>
             <a class="w3-btn  w3-indigo w3-border w3-border-dark-blue w3-round-xlarge" href="#/blogList" role="button">View Blogs</a>
          </div>
        </div>
      </div>
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
